...
export default function SignIn() {
  ...
  return (
    <div className="relative min-h-screen bg-black pt-0 mt-0 top-0 flex flex-col justify-start">
      <video
        autoPlay
        muted
        loop
      ...
      {/* Content */}
      <div className="relative flex p-6 mt-0 max-w-6xl mx-auto flex-col md:flex-row items-center justify-between gap-12 z-10">
          ...
          <div className=" bg-opacity-60 p-8 rounded-lg">
            ...
            >
              ...
              <Button
                type="submit"
                disabled={loading}
                className="bg-gradient-to-r from-[#0119FF] via-[#0093FF] to-[#3AF7F0] rounded-lg w-28 h-8 flex items-center justify-center 
                px-1 py-1 text-sm text-white transition duration-300 ease-in-out"
              >
                {loading ? (
                  <>
                    <Spinner size="sm" />
              ...
              {/* Sign Up Link */}
              <div className="text-center text-sm text-white w-3/4">
            ...
            {/* Error Message */}
            {error && (
              <Alert className="mt-4 w-3/4 mx-auto" color="failure">
                {error}
              </Alert>
            )}
          </div>
