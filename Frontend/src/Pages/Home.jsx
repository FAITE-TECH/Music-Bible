...
import { FaCogs, FaPhone, FaShieldAlt, FaUser } from "react-icons/fa";
  ...
  return (
    <>
      ...
      >
        ...
        <motion.div className="fixed bottom-0 left-4 z-10">
          <a
        ...
        <motion.div className="fixed bottom-2 right-4 z-10">
          <a
        ...
        <div className="container mx-auto flex flex-wrap items-center justify-between">
          ...
          >
            ...
            <p className="text-lg text-gray-300 leading-relaxed">
              We warmly invite you to continue your spiritual journey with us.
              At <strong>aMusicBible</strong>, we are dedicated to supporting
              your spiritual growth by providing everything you need to deepen
              your faith. Discover new and uplifting resources, such as guided
              meditations, peaceful rhythms, and insights into the true essence
              of a Christian life. We’d also love to hear from you—share your
              testimonies and feedback with us, and let’s grow together in faith
              and love. Your journey is our joy!
            </p>
            <motion.a
              href="/membership"
      ...
      <section
        ...
        style={{
          backgroundImage:
            "radial-gradient(circle at bottom, #60a5fa, #000000 50%)",
        }}
      >
        <div
          className="w-full md:w-3/4 bg-black bg-opacity-70 rounded-3xl shadow-2xl p-8 md:p-12 backdrop-blur-md flex flex-col md:flex-row justify-between"
          data-aos="fade-up"
        >
          <div className="flex flex-col justify-center mb-8 md:mb-0 md:w-1/2">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Features Of <span className="text-yellow-400">aMusicBible</span>{" "}
              App
            </h2>
          </div>

          <div
            className="space-y-6 md:space-y-8 w-full md:w-1/2 border border-gray-600 rounded-lg p-6"
            data-aos="fade-left"
          >
            <div
              className="flex flex-col md:flex-row justify-start items-center md:justify-start space-y-4 md:space-y-0"
              data-aos="fade-left"
            >
              ...
              <div className="text-center md:text-left ">
                ...
                <p className="text-gray-300 text-base md:text-lg">
                  You can enjoy with the best spiritual experience.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div className="text-center md:text-left">
                ...
                <p className="text-gray-300 text-base md:text-lg">
                  Complete data protection with top-tier security.
                </p>
              </div>
            </div>
          </div>
      ...
      >
        <div className="max-w-4xl text-center">
          ...
          <p className="text-lg sm:text-xl leading-relaxed">
            ...
            Bible in a beautifully composed music format. With aMusicBible,
            users can immerse themselves in the Word of God through melodies
            that inspire worship, reflection, and spiritual growth. Perfect for
            personal devotion, group studies, or simply enjoying the uplifting
            power of Scripture-based music, aMusicBible makes the Bible more
            accessible and engaging for believers worldwide.
          </p>
        </div>
      </section>
