            ...
            <div className="flex items-center space-x-1 h-full">
              {navItems.map((item, index) => (
                <button
                  ...
                  className={`relative flex items-center justify-center px-1 py-1 rounded-full bg-transparent text-sm transition-all duration-300  ${
                    location.pathname === item.path
                      ? " ring-blue-700 border border-blue-500"
                      : ""
                  }`}
                >
