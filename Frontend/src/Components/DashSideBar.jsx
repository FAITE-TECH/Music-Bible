          ...
          <Sidebar className="w-full h-full bg-black">
            <Sidebar.Items className="flex flex-col h-full">
              <Sidebar.ItemGroup className="flex-grow">
                <Link to='/dashboard?tab=profile' key="profile" className="block" onClick={handleLinkClick}>
                  <Sidebar.Item 
                    active={tab === 'profile'} 
                    icon={HiUser} 
                    ...
                    labelColor='dark'
                    as='div'
                    className={`w-full px-4 py-3 transition-all duration-300 ${tab === 'profile' ? 
                ...
                {currentUser?.isAdmin && (
                  <>
                    <Link to='/dashboard?tab=users' key="users" className="block" onClick={handleLinkClick}>
                      <Sidebar.Item
                        active={tab === 'users'}
                        icon={HiOutlineUserGroup}
                        as='div'
                        className={`w-full px-4 py-3 transition-all duration-300 ${tab === 'users' ? 
                          'bg-gradient-to-r from-[#0119FF] via-[#0093FF] to-[#3AF7F0] text-white' : 
                          'hover:bg-gradient-to-r hover:from-[#0119FF] hover:via-[#0093FF] hover:to-[#3AF7F0] hover:text-white'}`}
                      >
                        Users
                    ...
                    <Link to='/dashboard?tab=music' key="music" className="block" onClick={handleLinkClick}>
                      <Sidebar.Item
                        ...
                        icon={HiMusicNote}
                        as='div'
                        className={`w-full px-4 py-3 transition-all duration-300 ${tab === 'music' ? 
                          'bg-gradient-to-r from-[#0119FF] via-[#0093FF] to-[#3AF7F0] text-white' : 
                          'hover:bg-gradient-to-r hover:from-[#0119FF] hover:via-[#0093FF] hover:to-[#3AF7F0] hover:text-white'}`}
                      >
                        Musics
                    ...
                    <Link to='/dashboard?tab=contact' key="contact" className="block" onClick={handleLinkClick}>
                      <Sidebar.Item
                        active={tab === 'contact'}
                        icon={HiOutlineMail}
                        as='div'
                        className={`w-full px-4 py-3 transition-all duration-300 ${tab === 'contact' ? 
                          'bg-gradient-to-r from-[#0119FF] via-[#0093FF] to-[#3AF7F0] text-white' : 
                          'hover:bg-gradient-to-r hover:from-[#0119FF] hover:via-[#0093FF] hover:to-[#3AF7F0] hover:text-white'}`}
                      >
                        Contact Requests
                  ...
                  Music Albums
                    ...
                    <Link to='/dashboard?tab=membership' key="membership" className="block" onClick={handleLinkClick}>
                      <Sidebar.Item
                        ...
                        icon={HiGift}
                        as='div'
                        className={`w-full px-4 py-3 transition-all duration-300 ${tab === 'membership' ? 
                          'bg-gradient-to-r from-[#0119FF] via-[#0093FF] to-[#3AF7F0] text-white' : 
                          'hover:bg-gradient-to-r hover:from-[#0119FF] hover:via-[#0093FF] hover:to-[#3AF7F0] hover:text-white'}`}
                      >
                        Membership Requests
