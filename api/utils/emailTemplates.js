...
export const membershipAcceptedEmail = (name) => {
    return `
        <div style="font-family: Arial, sans-serif; color: #333;">
            ...
            <p>We hope you enjoy the benefits of being a member of <strong>AmusicBible</strong>. If you have any questions, feel free to reach out to us at <a href="mailto:support@amusicbible.com">support@amusicbible.com</a>.</p>
            <br>
            <p>Best regards,</p>
...
export const membershipRejectedEmail = (name) => {
    return `
        <div style="font-family: Arial, sans-serif; color: #333;">
            ...
            <p>If you have any questions or would like to reapply in the future, feel free to contact our support team at <a href="mailto:support@amusicbible.com">support@amusicbible.com</a>.</p>
            <br>
            <p>Best regards,</p>
            <p>The amusic Bible Team</p>
            <hr>
